    ...
    public partial class Registro : Page
    {
        ...
        public static ApiResponse RegisterUser(RegisterDto dto)
        {
            try
            {
                ...
                if (dto == null) return ApiResponse.Fail("Datos inválidos (dto null).");
                ...
                DateTime birth;
                if (!DateTime.TryParse(dto.birthDate, out birth))
                    return ApiResponse.Fail("Fecha de nacimiento inválida: " + (dto.birthDate ?? "null"));
            ...
            {
                return ApiResponse.Fail("EX: " + ex.Message);
            }
        }
    }
}